...
namespace Game
{
    ...
    public class Playback
    {
        ...
        public void Init()
        {
            ...
            String filepath = Path.Combine(Controller.soundFolder, "test_sound.wav");
            bool a = File.Exists("assets\\audio\\test_sound");
            bool b = File.Exists("assets\\shaders\\fs.glsl");
            bool c = File.Exists(filepath);
            Stream file = File.Open(filepath, FileMode.Open);
            var sound_data = Playback.LoadWave(
                file,
                out channels,
                out bits_per_sample,
                out sample_rate);
            ...
            AL.GenSources(MySources); // gen 2 Source Handles
            int[] TestSources = new int[2];
            ...
            int channels, bits_per_sample, sample_rate;
            String filename = Path.Combine(Controller.soundFolder, "test_sound.wav");
