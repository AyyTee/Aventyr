...
namespace Lidgren.Network
{
	...
	{
	    double m_sentPingTime;
	    int m_sentPingNumber;
	    double m_averageRoundtripTime;
	    double m_timeoutDeadline = double.MaxValue;
		...
		internal void SendPing()
		{
			...
			NetOutgoingMessage om = (NetOutgoingMessage)m_peer.CreateMessage(1);
		...
		internal void SendPong(int pingNumber)
		{
			...
			NetOutgoingMessage om = (NetOutgoingMessage)m_peer.CreateMessage(5);
