...
namespace TimeLoopInc
{
    public class SceneController
    {
        ...
        public void Initialize()
        {
            ...
            _timelineRender = new TimelineRender(_scene, _window.Resources.LatoRegular());
        ...
        public void Render(double timeDelta)
        {
            ...
            gui.Renderables.Add(Draw.Text(_window.Resources.LatoRegular(), new Vector2(0, 30), _sceneRender.GetMouseGrid().ToString()));
